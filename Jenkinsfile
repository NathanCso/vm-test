        ...
        stage('Setup and Install Ansible') {
            steps {
                sh '''
                    ...
                    apt-get install -y python3 python3-pip python3-venv || { echo "Failed to install dependencies"; exit 1; }
                    ...
                    source ansible_env/bin/activate && pip install ansible || { echo "Failed to install Ansible"; exit 1; }
        ...
        stage('Run Ansible Playbook') {
            steps {
                sh '''
                    ...
                    source ansible_env/bin/activate && ansible-playbook -i ansible/hosts.ini ansible/playbook.yml || { echo "Failed to execute playbook"; exit 1; }
                '''
            }
        }
    }
